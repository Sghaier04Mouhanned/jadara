    ...
    >
      ...
      >
        ...
        <a href="/" style={{
          ...
          color: "#5A7A9A", fontSize: "0.78rem", textDecoration: "none",
          marginBottom: 16,
        ...
        <div style={{ marginBottom: 4 }}>
          ...
          >
            Fynd<span style={{ fontSize: "20px", color: COLORS.textMuted, background: "none", WebkitTextFillColor: COLORS.textMuted }}>.tn</span>
          </h1>
          <p
            style={{
              fontFamily: "var(--font-syne, 'Syne', sans-serif)",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 40, maxWidth: 820 }}>
            ...
            >
              ...
              <div style={{ fontSize: 15, color: COLORS.teal, fontWeight: 400 }}>
                Fynd tells you exactly why. And what to do next.
              </div>
            </div>
        ...
        {view === "analyzing" && (
          <div style={{ maxWidth: 620, position: "relative" }}>
            <div style={{
              ...
              background: "radial-gradient(ellipse at 50% 40%, rgba(78,205,196,0.06) 0%, transparent 65%)",
              ...
              {activeTab === 0 && (
                <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                      <label style={{ fontSize: 11, color: COLORS.teal, textTransform: "uppercase", fontWeight: 600 }}>Fynd Optimized Version (ATS-Ready)</label>
                      <div
                        style={{
                          height: 300,
                          overflowY: "auto",
